package com.labella.store.customer.web.rest;
...
import com.labella.store.customer.config.KafkaProperties;
...
class LabellaStoreAppCustomerKafkaResourceIT {
    ...
    void setup() {
        ...
        LabellaStoreAppCustomerKafkaResource kafkaResource = new LabellaStoreAppCustomerKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/labella-store-app-customer-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/labella-store-app-customer-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
