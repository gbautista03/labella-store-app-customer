...
import com.labella.store.customer.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.labella.store.customer.domain.Address}.
 */
@RestController
@RequestMapping("/api")
public class AddressResource {
    ...
    private static final String ENTITY_NAME = "labellaStoreAppCustomerAddress";
