...
@RestController
@RequestMapping("/api/labella-store-app-customer-kafka")
public class LabellaStoreAppCustomerKafkaResource {
    private final Logger log = LoggerFactory.getLogger(LabellaStoreAppCustomerKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public LabellaStoreAppCustomerKafkaResource(KafkaProperties kafkaProperties) {
